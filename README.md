...
| `list-wallets`      | List all your customer's crypto wallets       | [list-binance.ts](list-wallet/list-binance.ts)                                    | 
| `delete-wallet`     | Delete a crypto wallet                        | [delete-binance.ts](delete-wallet%2Fdelete-binance.ts)[Link](https://link-gh.com) |
